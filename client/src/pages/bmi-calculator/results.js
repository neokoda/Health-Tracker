...
export default function BMICalculator() {
    ...
    <div>
        <Header></Header>
        <Background>
        <div className="w-4/12 bg-white rounded-xl p-10 flex flex-col items-center">
            <h1 className="text-center text-3xl font-bold">Your BMI Is:</h1>
            <h1 className="text-red-500 text-5xl mt-4 mb-2 font-bold">{BMI}</h1>
            <h2 className="text-lg mb-2">You're classified as <span>{classifyBMI}</span>.</h2>
            <div className="flex flex-row">
                ...
                <Link href="../." className="overflow-hidden rounded-md py-3 px-6 mt-4 mx-2 bg-gray-300 font-bold shadow-lg transition hover:brightness-90 duration-300">Back to Homepage</Link>
            </div>        
        </div>
        </Background>
    </div>
